...
unlocked to sign the Borgcoin-Qt.app bundle.
...
allowing somebody to distribute a Borgcoin-Qt.app or bitcoin-qt-setup.exe with a valid
...
that the borgcoin-qt.exe file inside the installer had not been tampered with.
